        ...
        <div className='mt-10'>
            ...
            <div className='flex flex-wrap items-start gap-5 justify-center'>
              <ul data-aos="flip-right" data-aos-duration="1000" className='flex flex-col border bg-blue-50 border-black dark:border-white dark:bg-black items-start rounded-md shadow-sm shadow-white gap-2 flex-wrap justify-center p-2'>
                <li className='list-item-style'><span className='flex items-center gap-1'><Html /> <span className='w-[120px] text-left'>Html</span> </span> <span className='hidden sm:block sm:w-[150px] mr-6 bg-[#fa043d] rounded-sm h-1'></span> <span className='flex items-center gap-1'> <BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/> </span></li>
                <li className='list-item-style'><span className='flex items-center gap-1'><Css/> <span className='w-[120px] text-left'>CSS</span> </span> <span className='hidden sm:block sm:w-[150px] mr-6 bg-[#fa043d] rounded-sm h-1'></span> <span className='flex items-center gap-1'> <BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/> </span></li>
                <li className='list-item-style'><span className='flex items-center gap-1'><Scss/> <span className='w-[120px] text-left'>SCSS</span> </span> <span className='hidden sm:block sm:w-[150px] mr-6 bg-[#fa043d] rounded-sm h-1'></span> <span className='flex items-center gap-1'> <BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/> </span></li>
                {/* <li className='list-item-style'><span className='flex items-center gap-1'><Bs/> <span className='w-[120px] text-left'>Bootstrap</span> </span> <span className='hidden sm:block sm:w-[150px] mr-6 bg-[#fa043d] rounded-sm h-1'></span><span className='flex items-center gap-1'> <BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/> </span></li> */}
                <li className='list-item-style'><span className='flex items-center gap-1'><Tailwind/> <span className='w-[120px] text-left'>Tailwind Css </span></span> <span className='hidden sm:block sm:w-[150px] mr-6 bg-[#fa043d] rounded-sm h-1'></span> <span className='flex items-center gap-1'><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/></span></li>
            </ul>
            <ul data-aos="flip-left" data-aos-duration="1000" className='flex flex-col border bg-blue-50 border-black dark:border-white dark:bg-black items-start rounded-md shadow-sm shadow-white gap-2 flex-wrap justify-center p-2'>
                <li className='list-item-style'><span className='flex items-center gap-1'><Js/> <span className='w-[120px] text-left'>JavaScript</span></span> <span className='hidden sm:block sm:w-[150px] mr-6 bg-[#fa043d] rounded-sm h-1'></span> <span className='flex items-center gap-1'> <BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/> <BsStarHalf className='text-[#FFD700] dark:text-white'/></span></li>
                <li className='list-item-style'><span className='flex items-center gap-1'><Ts/> <span className='w-[120px] text-left'>TypeScript</span> </span> <span className='hidden sm:block sm:w-[150px] mr-6 bg-[#fa043d] rounded-sm h-1'></span><span className='flex items-center gap-1'> <BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BiStar className='text-[#FFD700] dark:text-white'/></span></li>
                {/* <li className='list-item-style'><span className='flex items-center gap-1'><Jq/> <span className='w-[120px] text-left'>jQuery</span> </span> <span className='hidden sm:block sm:w-[150px] mr-6 bg-[#fa043d] rounded-sm h-1'></span> <span className='flex items-center gap-1'><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BiStar /></span></li> */}
                <li className='list-item-style'><span className='flex items-center gap-1'><ReactL/> <span className='w-[120px] text-left'>React Js</span> </span><span className='hidden sm:block sm:w-[150px] mr-6 bg-[#fa043d] rounded-sm h-1'></span><span className='flex items-center gap-1'> <BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarHalf className='text-[#FFD700] dark:text-white'/></span></li>
                <li className='list-item-style'><span className='flex items-center gap-1'><TbBrandNextjs className='w-10 h-10 p-1 bg-white shadow-sm dark:bg-black' />  <span className='w-[120px] text-left'>Next Js</span> </span> <span className='hidden sm:block sm:w-[150px] mr-6 bg-[#fa043d] rounded-sm h-1'></span><span className='flex items-center gap-1'> <BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarHalf className='text-[#FFD700] dark:text-white'/></span></li>
            </ul>
            </div>
