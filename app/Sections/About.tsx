    ...
    <div className={`mt-16 text-center bg-white dark:bg-black p-4`}>
        ...
        <div className='flex gap-5 flex-col md:flex-row items-center justify-center m-auto'>
          <div className='w-[250px] sm:w-[320px] h-[250px] sm:h-[350px] border-[#fa043d] border-4 rounded-full overflow-hidden bg-[#fa043d] flex items-center'>
            <Image data-aos="zoom-in" data-aos-duration="2000" className='mx-auto' src={DevImage} alt='An Image of Kayode Uthman'/>
          </div>
        ...
        <div className='mt-10'>
            ...
            <ul data-aos="flip-left" data-aos-duration="1000" className='flex flex-col border bg-blue-50 border-black dark:border-white dark:bg-black items-start rounded-md shadow-sm shadow-white gap-2 flex-wrap justify-center p-2'>
                ...
                <li className='list-item-style'><span className='flex items-center gap-1'><Next/> <span className='w-[120px] text-left'>Next Js</span> </span> <span className='hidden sm:block sm:w-[150px] mr-6 bg-[#fa043d] rounded-sm h-1'></span><span className='flex items-center gap-1'> <BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarFill className='text-[#FFD700] dark:text-white'/><BsStarHalf className='text-[#FFD700] dark:text-white'/></span></li>
            </ul>
            </div>
