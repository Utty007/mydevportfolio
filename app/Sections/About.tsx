      ...
      <h1 className=' text-5xl text-[#fa043d]'>About Uthman</h1>
        ...
        <div className='mt-10'>
            ...
            <div className='flex flex-wrap items-start gap-5 justify-center'>
              <ul className='flex flex-col border bg-blue-50 border-black dark:border-white dark:bg-black items-start rounded-md shadow-sm shadow-white gap-2 flex-wrap justify-center p-2'>
