...
function Home() {
  ...
  return (
    <div id='Home' className='flex flex-col md:flex-row-reverse justify-evenly items-center px-12 bg-[#eff6ff] text-[#24292c] dark:bg-[#24292c] dark:text-white'>
        ...
        <div className='sm:w-[500px] sm:h-[500px] w-[350px] h-[350px] cursor-pointer flex items-center'>
